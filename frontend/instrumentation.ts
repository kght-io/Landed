...
// interview brief) instead of the DB reaching up into the queue — see backend/src/db/stage-change.ts
...
// queueing the brief. Registering here makes it unconditional and independent of import order.
//
